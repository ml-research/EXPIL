...
from expil.aitk.utils import log_utils
from expil.aitk.utils.fol.data_utils import DataUtils
from expil.aitk.infer import ClauseInferModule
from expil.aitk.tensor_encoder import TensorEncoder
from expil.aitk.utils.fol import logic
...
def generate_atoms(lang):
    spec_atoms = [nesy_pi.aitk.utils.fol.language.false, nesy_pi.aitk.utils.fol.language.true]
    atoms = []
